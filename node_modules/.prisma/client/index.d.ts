  ...
  */
  ...
  export type AddressGetPayload<S extends boolean | null | undefined | AddressArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'Vendor' ? VendorGetPayload<S['include'][P]> | null :  never
  } 
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'Vendor' ? VendorGetPayload<S['select'][P]> | null :  P extends keyof Address ? Address[P] : never
  } 
      : Address
  ...
  export type VendorSelect = {
    ...
    lastUpdateDate?: boolean
    Resource?: boolean | ResourceFindManyArgs
    Invoice?: boolean | InvoiceFindManyArgs
    User?: boolean | UserFindManyArgs
  ...
  export type VendorGetPayload<S extends boolean | null | undefined | VendorArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'Resource' ? Array < ResourceGetPayload<S['include'][P]>>  :
        P extends 'Invoice' ? Array < InvoiceGetPayload<S['include'][P]>>  :
        P extends 'User' ? Array < UserGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'Resource' ? Array < ResourceGetPayload<S['select'][P]>>  :
        P extends 'Invoice' ? Array < InvoiceGetPayload<S['select'][P]>>  :
        P extends 'User' ? Array < UserGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__VendorClient<T, Null = never> implements PrismaPromise<T> {
    ...
    Resource<T extends ResourceFindManyArgs= {}>(args?: Subset<T, ResourceFindManyArgs>): PrismaPromise<Array<ResourceGetPayload<T>>| Null>;
  ...
  export type ResourceGetPayload<S extends boolean | null | undefined | ResourceArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Resource :
    S extends undefined ? never :
    S extends { include: any } & (ResourceArgs | ResourceFindManyArgs)
    ? Resource  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'vendor' ? VendorGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (ResourceArgs | ResourceFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'vendor' ? VendorGetPayload<S['select'][P]> :  P extends keyof Resource ? Resource[P] : never
  } 
      : Resource
  ...
  export interface ResourceDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Resource'> extends True ? Prisma__ResourceClient<ResourceGetPayload<T>> : Prisma__ResourceClient<ResourceGetPayload<T> | null, null>
    ...
    **/
    findUniqueOrThrow<T extends ResourceFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, ResourceFindUniqueOrThrowArgs>
    ): Prisma__ResourceClient<ResourceGetPayload<T>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Resource'> extends True ? Prisma__ResourceClient<ResourceGetPayload<T>> : Prisma__ResourceClient<ResourceGetPayload<T> | null, null>
    ...
    **/
    findFirstOrThrow<T extends ResourceFindFirstOrThrowArgs>(
      args?: SelectSubset<T, ResourceFindFirstOrThrowArgs>
    ): Prisma__ResourceClient<ResourceGetPayload<T>>
    ...
    **/
    ...
    ): PrismaPromise<Array<ResourceGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ResourceClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type ResourceFindUniqueArgsBase = {
    /**
   ...
   * Resource: findUnique
   */
  export interface ResourceFindUniqueArgs extends ResourceFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type ResourceFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Resource
     * 
    **/
   ...
   * Resource: findFirst
   */
  export interface ResourceFindFirstArgs extends ResourceFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  export type InvoiceWhereInput = {
    ...
    cycle?: EnumInvoiceCycleFilter | InvoiceCycle
    vendor?: XOR<VendorRelationFilter, VendorWhereInput> | null
    vendorId?: IntNullableFilter | number | null
    account?: XOR<AccountRelationFilter, AccountWhereInput> | null
    accountId?: IntNullableFilter | number | null
  ...
  export type InvoiceScalarWhereWithAggregatesInput = {
    ...
    cycle?: EnumInvoiceCycleWithAggregatesFilter | InvoiceCycle
    vendorId?: IntNullableWithAggregatesFilter | number | null
    accountId?: IntNullableWithAggregatesFilter | number | null
  ...
  export type VendorCreateInput = {
    ...
    accountContactPhone?: string | null
    lastUpdateDate?: Date | string
    Resource?: ResourceCreateNestedManyWithoutVendorInput
  ...
  export type VendorUncheckedCreateInput = {
    ...
    accountContactPhone?: string | null
    lastUpdateDate?: Date | string
    Resource?: ResourceUncheckedCreateNestedManyWithoutVendorInput
  ...
  export type VendorUpdateInput = {
    ...
    lastUpdateDate?: DateTimeFieldUpdateOperationsInput | Date | string
    Resource?: ResourceUpdateManyWithoutVendorNestedInput
  ...
  export type VendorUncheckedUpdateInput = {
    ...
    accountContactPhone?: NullableStringFieldUpdateOperationsInput | string | null
    lastUpdateDate?: DateTimeFieldUpdateOperationsInput | Date | string
    Resource?: ResourceUncheckedUpdateManyWithoutVendorNestedInput
  ...
  export type ResourceCreateInput = {
    ...
    vendor?: VendorCreateNestedOneWithoutResourceInput
    rate: number
    currency?: string
  }
  ...
  export type ResourceUpdateInput = {
    ...
    vendor?: VendorUpdateOneRequiredWithoutResourceNestedInput
  ...
  export type InvoiceUpdateInput = {
    ...
    cycle?: EnumInvoiceCycleFieldUpdateOperationsInput | InvoiceCycle
  ...
  export type ResourceCreateNestedManyWithoutVendorInput = {
    create?: XOR<Enumerable<ResourceCreateWithoutVendorInput>, Enumerable<ResourceUncheckedCreateWithoutVendorInput>>
    connectOrCreate?: Enumerable<ResourceCreateOrConnectWithoutVendorInput>
    createMany?: ResourceCreateManyVendorInputEnvelope
  ...
  export type ResourceUncheckedCreateNestedManyWithoutVendorInput = {
    create?: XOR<Enumerable<ResourceCreateWithoutVendorInput>, Enumerable<ResourceUncheckedCreateWithoutVendorInput>>
    connectOrCreate?: Enumerable<ResourceCreateOrConnectWithoutVendorInput>
    createMany?: ResourceCreateManyVendorInputEnvelope
    connect?: Enumerable<ResourceWhereUniqueInput>
  ...
  export type ResourceUpdateManyWithoutVendorNestedInput = {
    create?: XOR<Enumerable<ResourceCreateWithoutVendorInput>, Enumerable<ResourceUncheckedCreateWithoutVendorInput>>
    connectOrCreate?: Enumerable<ResourceCreateOrConnectWithoutVendorInput>
    upsert?: Enumerable<ResourceUpsertWithWhereUniqueWithoutVendorInput>
    createMany?: ResourceCreateManyVendorInputEnvelope
    ...
    connect?: Enumerable<ResourceWhereUniqueInput>
    update?: Enumerable<ResourceUpdateWithWhereUniqueWithoutVendorInput>
    updateMany?: Enumerable<ResourceUpdateManyWithWhereWithoutVendorInput>
  ...
  export type ResourceUncheckedUpdateManyWithoutVendorNestedInput = {
    create?: XOR<Enumerable<ResourceCreateWithoutVendorInput>, Enumerable<ResourceUncheckedCreateWithoutVendorInput>>
    connectOrCreate?: Enumerable<ResourceCreateOrConnectWithoutVendorInput>
    upsert?: Enumerable<ResourceUpsertWithWhereUniqueWithoutVendorInput>
    createMany?: ResourceCreateManyVendorInputEnvelope
  ...
  export type VendorCreateNestedOneWithoutResourceInput = {
    create?: XOR<VendorCreateWithoutResourceInput, VendorUncheckedCreateWithoutResourceInput>
    connectOrCreate?: VendorCreateOrConnectWithoutResourceInput
    connect?: VendorWhereUniqueInput
  }

  export type VendorUpdateOneRequiredWithoutResourceNestedInput = {
    create?: XOR<VendorCreateWithoutResourceInput, VendorUncheckedCreateWithoutResourceInput>
    connectOrCreate?: VendorCreateOrConnectWithoutResourceInput
    upsert?: VendorUpsertWithoutResourceInput
    connect?: VendorWhereUniqueInput
    update?: XOR<VendorUpdateWithoutResourceInput, VendorUncheckedUpdateWithoutResourceInput>
  }
  ...
  export type ResourceCreateWithoutVendorInput = {
    firstName: string
    lastName: string
    description?: string | null
    email: string
  ...
  export type ResourceUncheckedCreateWithoutVendorInput = {
    id?: number
    firstName: string
    lastName: string
    description?: string | null
  ...
  export type ResourceCreateOrConnectWithoutVendorInput = {
    where: ResourceWhereUniqueInput
    create: XOR<ResourceCreateWithoutVendorInput, ResourceUncheckedCreateWithoutVendorInput>
  }

  export type ResourceCreateManyVendorInputEnvelope = {
    data: Enumerable<ResourceCreateManyVendorInput>
    skipDuplicates?: boolean
  }
  ...
  export type ResourceUpsertWithWhereUniqueWithoutVendorInput = {
    where: ResourceWhereUniqueInput
    update: XOR<ResourceUpdateWithoutVendorInput, ResourceUncheckedUpdateWithoutVendorInput>
    create: XOR<ResourceCreateWithoutVendorInput, ResourceUncheckedCreateWithoutVendorInput>
  }

  export type ResourceUpdateWithWhereUniqueWithoutVendorInput = {
    where: ResourceWhereUniqueInput
    data: XOR<ResourceUpdateWithoutVendorInput, ResourceUncheckedUpdateWithoutVendorInput>
  }

  export type ResourceUpdateManyWithWhereWithoutVendorInput = {
    where: ResourceScalarWhereInput
    data: XOR<ResourceUpdateManyMutationInput, ResourceUncheckedUpdateManyWithoutResourceInput>
  }
  ...
  export type VendorCreateWithoutResourceInput = {
    name: string
    description?: string | null
    email: string
    phone?: string
  ...
  export type VendorUncheckedCreateWithoutResourceInput = {
    id?: number
    name: string
    description?: string | null
    email: string
  ...
  export type VendorCreateOrConnectWithoutResourceInput = {
    where: VendorWhereUniqueInput
    create: XOR<VendorCreateWithoutResourceInput, VendorUncheckedCreateWithoutResourceInput>
  }

  export type VendorUpsertWithoutResourceInput = {
    update: XOR<VendorUpdateWithoutResourceInput, VendorUncheckedUpdateWithoutResourceInput>
    create: XOR<VendorCreateWithoutResourceInput, VendorUncheckedCreateWithoutResourceInput>
  }

  export type VendorUpdateWithoutResourceInput = {
    name?: StringFieldUpdateOperationsInput | string
    description?: NullableStringFieldUpdateOperationsInput | string | null
    email?: StringFieldUpdateOperationsInput | string
    phone?: StringFieldUpdateOperationsInput | string
  ...
  export type VendorUncheckedUpdateWithoutResourceInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    description?: NullableStringFieldUpdateOperationsInput | string | null
    email?: StringFieldUpdateOperationsInput | string
  ...
  export type ResourceCreateManyVendorInput = {
    id?: number
    firstName: string
    lastName: string
    description?: string | null
  ...
  export type ResourceUpdateWithoutVendorInput = {
    firstName?: StringFieldUpdateOperationsInput | string
    lastName?: StringFieldUpdateOperationsInput | string
    description?: NullableStringFieldUpdateOperationsInput | string | null
    email?: StringFieldUpdateOperationsInput | string
  ...
  export type ResourceUncheckedUpdateWithoutVendorInput = {
    id?: IntFieldUpdateOperationsInput | number
    firstName?: StringFieldUpdateOperationsInput | string
    lastName?: StringFieldUpdateOperationsInput | string
    description?: NullableStringFieldUpdateOperationsInput | string | null
