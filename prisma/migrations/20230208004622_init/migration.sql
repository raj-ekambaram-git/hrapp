...
-- CreateIndex
CREATE INDEX "fki_qrtz_simple_triggers_qrtz_triggers" ON "qrtz_simple_triggers"("trigger_name", "trigger_group");

-- CreateIndex
CREATE INDEX "fki_qrtz_simple_triggers_job_details_name_group" ON "qrtz_triggers"("job_name", "job_group");
